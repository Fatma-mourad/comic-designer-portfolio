...
function CaseStudy() {
  ...
  return <article className={`case-study case-${project.tone}`}>
    ...
    <div className="case-body">
      <section className="case-opening"><p className="chapter-label">The setup</p><h2>Not every shortest path<br/>is the <em>clearest</em> one.</h2></section>
      ...
      <section className="process-strip" aria-label="Design process"><div><span>01</span><h3>Listen</h3><p>Context before concepts.</p></div><div><span>02</span><h3>Frame</h3><p>Find the useful question.</p></div><div><span>03</span><h3>Make</h3><p>Learn through prototypes.</p></div><div><span>04</span><h3>Refine</h3><p>Measure what matters.</p></div></section>
